package br.com.victorhugolgr.arquivolargurafixajob.reader;
...
public class LeituraArquivoLarguraFixaReaderConfig {
    @StepScope
    @Bean
    public FlatFileItemReader<Cliente> leituraArquivoLarguraFixaReader(@Value("classpath:files/clientes.txt")Resource arquivoClientes) {
